...
This file is a high-level orientation. For implementation-level detail on any one subsystem (auth, notes, watchlist, listens, backups, deployment, every env var), see [docs/](docs/README.md) — those docs go deeper than what's summarized below. [README.md](README.md) is the human-facing overview.
